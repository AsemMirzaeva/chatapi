...
from storeapi.tasks import APIResponseError, send_simple_email, _generate_cute_creature_api, generate_and_add_to_post
...
async def test_send_simple_email_api_error(mock_httpx_client):
    ...
    with pytest.raises(APIResponseError):
        await send_simple_email("test@example.net", "Test Subkect", "Test Body")
